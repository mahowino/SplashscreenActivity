...
import online.kenya.mvitu.Interceptor.AccessTokenInterceptor;
import online.kenya.mvitu.Interceptor.AuthInterceptor;
import online.kenya.mvitu.Services.STKPushService;
...
public class DarajaApiClient {
    ...
    private Retrofit getRestAdapter() {
        ...
        builder.baseUrl(MpesaConstants.BASE_URL);
