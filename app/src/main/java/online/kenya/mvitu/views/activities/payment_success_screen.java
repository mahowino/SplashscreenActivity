...
import static online.kenya.mvitu.constants.FirebaseCollections.CUSTOMER_REFERENCE;
import static online.kenya.mvitu.constants.FirebaseCollections.VOUCHER_REFERENCE;
...
import online.kenya.mvitu.FinalActivitySender;
...
import online.kenya.mvitu.controller.FirebaseRepository;
import online.kenya.mvitu.interfaces.Callback;
...
public class payment_success_screen extends AppCompatActivity {
    ...
    private Map createGoodsInVoucher(int pos) {
        Map<String,Object> map=new HashMap<>();
        map.put(FirebaseFields.GOOD_NAME,goodTypes.get(pos).getGoodName());
